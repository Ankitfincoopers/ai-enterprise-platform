...
//         { label: 'AR/VR Services', path: '/services/ar-vr-services' },
//         { label: 'Web and Mobile App Services', path: '/services/web-mobile-app-services' },
//       ]
//     },
...
//             {/* Services dropdown items in drawer */}
...
//                         to={item.path}
//                         onClick={(e) => {
//                           // Services page open होगा जब Services button पर click करेंगे
//                           navigate(item.path);
//                         }}
//                         sx={{
//                           color: 'rgba(255, 255, 255, 0.8)',
...
//                       {/* Services Dropdown Menu - Hover पर show होगा */}
//                       <Menu
//                         anchorEl={servicesMenuAnchor}
//                         open={Boolean(servicesMenuAnchor)}
//                         onClose={handleServicesMenuClose}
//                         MenuListProps={{ 
//                           onMouseEnter: () => setServicesMenuAnchor(servicesMenuAnchor),
//                           onMouseLeave: handleServicesMenuClose,
//                           sx: { py: 0 }
//                         }}
//                         PaperProps={{
...
//                   {item.hasDropdown ? (
//                     <Box
//                       onMouseEnter={(e) => handleServicesMenuOpen(e)}
//                       onMouseLeave={handleServicesMenuClose}
//                       sx={{ position: 'relative' }}
//                     >
//                       <Button
...
const Header = () => {
  ...
  const handleServicesMouseLeave = () => {
    // थोड़ा delay देकर close करें ताकि dropdown पर move करने का समय मिले
    setTimeout(() => {
